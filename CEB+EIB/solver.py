...
class Solver(object):
        ...
        for e in range(self.epoch) :
            ...
            for idx, (images,labels) in enumerate(self.data_loader['train']):
                ...
                info_loss = (-0.5 * alpha - alpha * std.log() +std2.log()+ 0.5 * (mu.pow(2) +mu2.pow(2)-2*mu.*mu2+ std.pow(2))./(std2.pow(2)) + (
                        1 - alpha) * 0.5 * math.log(2 * math.pi)).sum(1).mean().div(math.log(2))#逐项乘是.* !!!
                total_loss = class_loss + self.beta * info_loss
                ...
                if self.global_iter % 100 == 0 :
                    '''with open('train_izy_bound.txt', 'a+') as f:
                        f.write(str(izy_bound.item()) + '\n')
                    with open('train_izx_bound.txt', 'a+') as f:
                        f.write(str(izx_bound.item()) + '\n')
                    with open('train_accuracy.txt', 'a+') as f:
                        f.write(str(accuracy.item()) + '\n')
                    with open('train_avg_accuracy.txt', 'a+') as f:
                        f.write(str(avg_accuracy.item()) + '\n')
                    with open('train_error.txt', 'a+') as f:
                        f.write(str(1-accuracy.item()) + '\n')
                    with open('train_avg_error.txt', 'a+') as f:
                        f.write(str(1-avg_accuracy.item()) + '\n')
                    with open('train_error.txt', 'a+') as f:
                        f.write(str(1-accuracy.item()) + '\n')
                    with open('train_class_loss.txt', 'a+') as f:
                        f.write(str(class_loss.item()) + '\n')
                    with open('train_info_loss.txt', 'a+') as f:
                        f.write(str(info_loss.item()) + '\n')
                    with open('train_total_loss.txt', 'a+') as f:
                ...
                if self.global_iter % 10 == 0 :
                    with open('train_ht_bound.txt', 'a+') as f:
                        f.write(str(ht_bound.item()) + '\n')
                    with open('train_htx_bound.txt', 'a+') as f:
    ...
    def test(self, save_ckpt=True):
        ...
        hty_bound/=total_num#!!!
        ht_bound/=total_num
        with open('test_ht_bound.txt', 'a+') as f:
            f.write(str(ht_bound.item()) + '\n')
        with open('test_htx_bound.txt', 'a+') as f:
            f.write(str(htx_bound.item()) + '\n')
        with open('test_hty_bound.txt', 'a+') as f:
            f.write(str(hty_bound.item()) + '\n')#!!!
        with open('test_izy_bound.txt', 'a+') as f:
            f.write(str(izy_bound.item()) + '\n')
        with open('test_izx_bound.txt', 'a+') as f:
            f.write(str(izx_bound.item()) + '\n')
        with open('test_accuracy.txt', 'a+') as f:
            f.write(str(accuracy.item()) + '\n')
        with open('test_avg_accuracy.txt', 'a+') as f:
            f.write(str(avg_accuracy.item()) + '\n')
        with open('test_error.txt', 'a+') as f:
            f.write(str(1 - accuracy.item()) + '\n')
        with open('test_avg_error.txt', 'a+') as f:
            f.write(str(1 - avg_accuracy.item()) + '\n')
        with open('test_error.txt', 'a+') as f:
            f.write(str(1 - accuracy.item()) + '\n')
        with open('test_class_loss.txt', 'a+') as f:
            f.write(str(class_loss.item()) + '\n')
        with open('test_info_loss.txt', 'a+') as f:
            f.write(str(info_loss.item()) + '\n')
        with open('test_total_loss.txt', 'a+') as f:
            f.write(str(total_loss.item()) + '\n')
