...
def main(args):
    ...
    elif args.mode == 'real_test' : net.real_test()###!!!
    else : return 0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', default = 1e-2, type=float, help='learning rate')#4
    print(2)
    #parser.add_argument('--beta', default = 8e-5, type=float, help='beta')
    parser.add_argument('--K', default = 2, type=int, help='dimension of encoding Z')
    ...
    print(4)
    parser.add_argument('--mode',default='train', type=str, help='train or test or real_test')
    parser.add_argument('--tensorboard',default=False, type=str2bool, help='enable tensorboard')
    #args = parser.parse_args()
    parser.add_argument('--epoch', default=25, type=int, help='epoch size')
    parser.add_argument('--beta', default=1e-2, type=float, help='beta')
    parser.add_argument('--alpha', default=0, type=int, help='alpha')
