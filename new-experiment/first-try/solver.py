...
class Solver(object):
    ...
    def train(self):
        ...
        for e in range(self.epoch) :
            ...
            for (images,labels) in zip(train_data,train_label):
                self.global_iter += 1
...
#                izx_bound = ht_bound - htx_bound  # I(T,X)=H(T)-H(T|X)!!!
                ...
                if self.global_iter % 100 == 0 :
                    print(' class_loss:{:.2f} info_loss:{:.2f}' 'total_loss:{:.2f}' 
                            .format( class_loss.item(), class_loss.item(), total_loss.item()), end=' ')
...
#            f.write(str(total_loss.item()) + '\n')
        ...
        print('[TEST RESULT]')
        print(' e:{}  class_loss:{:.2f} info_loss:{:.2f} total_loss:{:.2f}' 
                            .format(self.global_epoch, class_loss.item(), class_loss.item(), total_loss.item()), end=' ')
